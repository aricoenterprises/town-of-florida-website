// SVG path strings for department icons — keyed by icon name.
// Used in officials.njk via: {{ iconSvgs[dept.icon] | safe }}
module.exports = {
  government:    '<path d="M3 21h18M6 21V10M18 21V10M12 21V10M3 10l9-7 9 7"/>',
  person:        '<path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  school:        '<path d="M3 21h18M3 7l9-4 9 4M4 7v14M20 7v14M9 21v-4a3 3 0 016 0v4"/>',
  ...
  fire:          '<path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>',
